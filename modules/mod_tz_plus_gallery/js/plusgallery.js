...
(function (jQuery){
    jQuery.fn.plusGallery = function(options,ipath){
        var lmnt = this;
        if(lmnt.length === 0) { return false; }
        var pg = {
            /*user defined Defaults*/
            imagePath: ipath+'images/plusgallery',
            type: null,
            ...
            parseData: function(json,title,pg_type,obj_click){
                ...
                jQuery.each(objPath,function(i,obj){
                    ...
                    if(i < pg.limit) {
                        ...
                        if(obj_click) {
                            jQuery('' + pg_ids + ' #pgthumbs').append('<li class="pgthumb"><a href="' + imgSrc + '"><img data-src="' + imgSrc + '" src="'+ pg.imagePath + '/square.png" id="pgthumbimg' + i + '" class="pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '></a></li>');
                        } else{
                            jQuery(lmnt).find('#pgthumbs').append('<li class="pgthumb"><a href="' + imgSrc + '"><img data-src="' + imgSrc + '" style="background-image: url(' + imgTh + ');" src="'+ pg.imagePath + '/square.png" id="pgthumbimg' + i + '" class="pgthumbimg" alt="' + imgTitle + '" title="' + imgTitle + '"' + imgBg + '></a></li>');
                        }
