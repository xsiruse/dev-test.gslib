...
class JFormFieldTZColor extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        if (!self::$initialised)
        {
            JFactory::getDocument() -> addStyleSheet(JUri::root().'/modules/mod_tz_plus_gallery/admin/formfields/css/spectrum.css');
            JFactory::getDocument() -> addScript(JUri::root().'/modules/mod_tz_plus_gallery/admin/formfields/js/spectrum.js');
        ...
        return '<input class="tzcolor" type="text" name="' . $this->name . '"  id="' . $this->id . '"' . ' value="'
