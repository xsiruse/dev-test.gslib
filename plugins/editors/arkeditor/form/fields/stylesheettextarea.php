...
class JFormFieldStylesheetTextarea extends JFormFieldTextarea 
{
	...
	protected function getInput()
	{
		...
		<br clear="left"/><br /><input type="button" class="btn" id="modal'.$identifier.'" href="index.php?option=com_arkeditor&view=typography&tmpl=component&e_id='.$this->id.'" rel="{handler: \'iframe\' , size: {x:640, y:480}}" value="Expand View"/>'.
        (!$this->allowDisable ? '' : '
