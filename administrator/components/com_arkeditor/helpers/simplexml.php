...
/**
 * ARKSimpleXML implementation.
 *
 * The XML Parser extension (expat) is required to use ARKSimpleXML.
 *
 ...
 * 		ARKSimpleXML, not implicit as with PHP5. Write
 ...
 * </code>
 *
 * Note: ARKSimpleXML cannot be used to access sophisticated XML doctypes
...
class ARKSimpleXML extends JObject
{
	/**
	 * The XML parser
	 *
	 ...
	 * ARKSimpleXMLElement with properties containing the data held within the XML document.
	 ...
	 *
	 * @return  object  ARKSimpleXMLElement
	 *
	 * @since   11.1
	 *
	 ...
	 * to an object  of class ARKSimpleXMLElement. If any errors occur during file access or
	...
	/**
	 * Get a ARKSimpleXMLElement object from a DOM node.
	 *
	 * This function takes a node of a DOM  document and makes it into a ARKSimpleXML node.
	 * This new object can then be used as a native ARKSimpleXML element. If any errors occur,
	 * it returns FALSE.
	 *
	 * @param   string  $node       DOM  document
	 * @param   string  $classname  currently ignored
	 *
	 * @return  mixed  ARKSimpleXMLElement or false if any errors occur
	 *
 ...
 */
class ARKSimpleXMLElement extends JObject
{
	/**
	 ...
	 *
	 * @return  ARKSimpleXMLElement  The added child object
	 *
	 * @deprecated   12.1
	 * @since   11.1
	 */
	 ...
	 *
	 * @param   ARKSimpleXmlElement  &$child  The child element to remove.
	 *
	 * @return  void
	 *
	 * @since   11.1
	...
	/**
	 * Traverses the tree calling the $callback(ARKSimpleXMLElement
	 * $this, mixed $args=array()) function with each ARKSimpleXMLElement.
	 *
