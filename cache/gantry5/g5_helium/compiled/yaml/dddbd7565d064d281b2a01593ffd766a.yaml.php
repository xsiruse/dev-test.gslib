...
return [
    ...
    'filename' => '/home/guitars1/dev-test.gslib.ru/public_html/templates/g5_helium/custom/particles/googlemap.yaml',
    'modified' => 1555874223,
    'data' => [
        'name' => 'Google Map',
        ...
        'form' => [
            'fields' => [
                ...
                'latitude' => [
                    ...
                    'default' => 52.052312000000000580257619731128215789794921875
                ],
                'longitude' => [
                    'type' => 'input.text',
                    'label' => 'Longitude',
                    'description' => 'Enter the longitude of the location.',
                    'default' => 4.4471410000000002327169568161480128765106201171875
                ],
                'zoom' => [
                    'type' => 'input.text',
                    'label' => 'Zoom',
